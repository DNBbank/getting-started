...
test('asv4.sign should sign based on request options for post with body', () => {
  ...
  expect(signature).toEqual('AWS4-HMAC-SHA256 Credential=clientId/20181009/eu-west-1/execute-api/aws4_request, SignedHeaders=host;x-amz-date, Signature=68a4604f296eced8522561f20cb7ce6e807d1beebfff4960f7e3ba3a27c9d0fa');
});
